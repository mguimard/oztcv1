...
public class Dates {
	...
	public static void main(String[] args) throws ParseException {
		DateTimeFormatter dateFormatter = DateTimeFormatter.ofPattern("dd-MM-uuuu"); // Line n1
		System.out.println(dateFormatter.parse("10-5-2019")); // Line

		NumberFormat currFormatter = NumberFormat.getCurrencyInstance(Locale.US); // Line n3
	...
	public static void main2(String[] args) {
		...
		/*
		 * Temporal Jour/Mois/Années LocalDate
		 * 
		 * Secondes/Minutes/Heures LocalTime
		 * 
		 * ---> LocalDateTime
		 * 
		 */
		...
		/*
		 * TemporalAmount Jour/Mois/Années -> Period Secondes/Minutes/Heures -> Duration
		 * 
		 * 
		 * 
		 * 
		 * A part ----> Instant: point dans le temps (jour/mois/année +
		 * heure/min/secondes
		 */
